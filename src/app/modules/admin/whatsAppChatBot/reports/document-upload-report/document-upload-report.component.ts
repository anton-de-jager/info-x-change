...
@Component({
  selector: 'app-document-upload-report',
  imports: [
      CommonModule,
      TableDynamicComponent
  ],
  templateUrl: './document-upload-report.component.html',
  styleUrl: './document-upload-report.component.scss'
})
export class DocumentUploadReportComponent implements AfterViewInit {
